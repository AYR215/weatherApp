...
function City ( { city } ) {
    ...
    async function getDailyWeather () {
        let response = await fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${city.lat}&lon=${city.long}&units=metric&exclude=current,minutely,daily,alerts&appid=8fce7e4d96a4a5a6f7f597c1fff64f4e`)
        let result = await response.json();
    ...
    async function getWeeklyWeather () {
        let response = await fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${city.lat}&lon=${city.long}&units=metric&exclude=current,minutely,hourly,alerts&appid=8fce7e4d96a4a5a6f7f597c1fff64f4e`)
        let result = await response.json();
